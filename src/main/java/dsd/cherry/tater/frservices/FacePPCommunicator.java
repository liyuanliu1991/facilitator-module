...
public class FacePPCommunicator {
     ...
     */
     protected String detectFace(byte[] data) {
        ...
        return result.toString();
          ...
          */
          private String addPerson(String personID){
        ...
        protected String trainPerson(String personID){
            ...
            JSONObject result = new JSONObject();
            try {
                result  = httpRequests.trainIdentify(new PostParameters().setPersonId(personID));
            } catch (FaceppParseException e){
                e.printStackTrace();
            }
            System.out.println("result: " + result.toString() + "\n");
    ...
    public static void main(String[] args) {
        ...
        fpp.createGroup();
     //   fpp.removePerson("person_5");
     //   fpp.removePersonWName("person_8");
        String personId = fpp.createPerson("person_8");
     ...
     //   fpp.removePerson(personId); //removing the person removes them from the group.
